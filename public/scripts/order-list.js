...
const pagination = () =>{
  let myHeaders = new Headers();
    ...
    fetch("/orders/findAll", requestOptions)
      ...
      function Pagination() {
         ...
         let changePage = function(page) {
             ...
             for(let i = (page -1) * records_per_page; i < (page * records_per_page) && i < objJson.length; i++) {
                 ...
                 const content = `
                 <td>${objJson[i]._id}</td>
                 <td id="td-${i}"><b>${objJson[i].completed}</b></td>
                 <td id="td2-${i}"><b>${objJson[i].processed}</b></td>
                 <td>${objJson[i].company}</td>
                 <td>${objJson[i].origin}</td>
                 <td>${objJson[i].destination}</td>
                 <td>${objJson[i].createdAt.slice(0, 10)}</td>
                 <td>${objJson[i].updatedAt.slice(0, 10)}</td>
                 <td>${objJson[i].category}</td>
                 <td id="td3-${i}"><b>${objJson[i].unsuccessful}</b></td>`;
             ...
             document.getElementById(`td2-${i}`).textContent === "true" ? 
                 document.getElementById(`td2-${i}`).style.color="green":
                 document.getElementById(`td2-${i}`).style.color="red"; 

                 document.getElementById(`td3-${i}`).textContent === "true" ? 
                 document.getElementById(`td3-${i}`).style.color="green":
                 document.getElementById(`td3-${i}`).style.color="red"; 
              }
